...
> **Note:** This is the Cursor IDE port. The Trae IDE version lives at [`.trae/skills/wiki/SKILL.md`](../../../.trae/skills/wiki/SKILL.md). They share the same intent and folder layout — keep both in sync.
...
- Session files use a **lighter session template** (see rule `06-documentation-hygiene.mdc`), not wiki section classification.
- After implementation work, both tracks are **mandatory companions** — see **Post-implementation checklist** below and always-on rule 06. Do not skip because the user did not say "မှတ်ထား".
...
Optionally suggest 1 related entry if obvious.

## Examples

| User says                                                        | Save to                                          |
| ---------------------------------------------------------------- | ------------------------------------------------ |
| "Tailwind v4 dark mode မှတ်ထားစမ်း"                              | `wiki/notes/2026-07-06-tailwind-v4-dark-mode.md` |
| "useEffect deps မှာ object pass မလုပ်ရဘူး convention သတ်မှတ်ထား" | `wiki/conventions/react-hook-deps.md`            |
| "Stripe သုံးဖို့ decision ယူထား"                                 | `wiki/decisions/001-use-stripe.md`               |
| "Button component snippet သိမ်းထား"                              | `wiki/snippets/button.md`                        |
