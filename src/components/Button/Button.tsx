...
export interface ButtonProps extends ButtonHTMLAttributes<HTMLButtonElement> {
  variant?: 'primary' | 'secondary' | 'outline' | 'ghost' | 'danger' | 'heroOutline' | 'accent'
  size?: 'sm' | 'md' | 'lg'
  isLoading?: boolean
...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const variants = {
      ...
      accent:
        'bg-accent-600 text-white hover:bg-accent-700 focus:ring-accent-500 active:bg-accent-700',
      heroOutline:
