    ...
    >
      <div className="mx-auto max-w-7xl px-4 py-8 text-left sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 items-start gap-8 lg:grid-cols-4">
          ...
          {/* RIGHT COLUMN: MAIN PROSE COOKIES SHEET */}
          <div className="lg:col-span-3">
            <div
              className={`rounded-3xl border p-6 shadow-sm transition-colors duration-300 sm:p-8 ${themeClasses[readingTheme]}`}
            >
              <h1 className="mb-2 text-2xl font-black sm:text-3xl">{t('static.cookiesTitle')}</h1>
              ...
              >
                ...
                <div className="border-primary-500/35 border-l-2 pl-4">
                  <h3 id="essential" className="text-base font-black dark:text-white">
                ...
                <div className="border-primary-500/35 border-l-2 pl-4">
                  <h3 id="analytics" className="text-base font-black dark:text-white">
                ...
                <div className="border-primary-500/35 border-l-2 pl-4">
                  <h3 id="functional" className="text-base font-black dark:text-white">
                ...
                <div className="border-primary-500/35 border-l-2 pl-4">
                  <h3 id="marketing" className="text-base font-black dark:text-white">
