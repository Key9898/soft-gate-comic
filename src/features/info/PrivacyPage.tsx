            ...
            >
              ...
              >
                ...
                <div className="border-primary-500/35 border-l-2 pl-4">
                  <h3 id="personal" className="text-base font-black dark:text-white">
                ...
                <div className="border-primary-500/35 border-l-2 pl-4">
                  <h3 id="usage" className="text-base font-black dark:text-white">
                    {t('static.usageData')}
                  </h3>
