    ...
    <div className="rounded-3xl border border-gray-200/60 bg-white p-5 shadow-sm">
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="focus-visible:ring-primary-500 text-muted -my-2 flex min-h-11 min-w-11 items-center justify-center rounded-2xl hover:text-gray-600 focus-visible:outline-none focus-visible:ring-2 lg:hidden"
        >
          <ChevronDown
