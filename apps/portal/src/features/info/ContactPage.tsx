...
const ContactPage = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (Object.keys(errs).length === 0) {
      ...
      const mailto = `mailto:${contactEmail}?subject=${encodeURIComponent(subject.trim())}&body=${encodeURIComponent(rawBody)}`
            ...
            <div className="lg:col-span-7">
              ...
              <div className="rounded-3xl border border-gray-200/60 bg-white p-6 shadow-xl sm:p-8">
                <div className="mb-6">
                  ...
                  <p className="text-2xs mt-1 font-bold uppercase tracking-wider text-gray-400">
                    {t('contact.formHint')}
                  </p>
                  {!isPitch && (
                    <>
                      ...
                      {isPitch ? (
                        <>
                          ...
                          >
                            <label
                              htmlFor={synopsisId}
                              className="pl-1 text-xs font-bold uppercase tracking-wider text-gray-400"
                            >
