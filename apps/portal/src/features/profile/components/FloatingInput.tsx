...
export const FloatingInput = ({
  ...
  return (
    ...
    >
      ...
      >
        {leftIcon && (
          <div className="left-4.5 absolute top-1/2 -translate-y-1/2 text-gray-400">{leftIcon}</div>
        )}
        ...
        {isPassword && (
          <button
            ...
            className="right-4.5 absolute top-1/2 -translate-y-1/2 text-gray-400 transition-colors hover:text-gray-600"
          >
            {showPassword ? (
              <svg
                viewBox="0 0 24 24"
        ...
        {rightIcon && !isPassword && (
          <div className="right-4.5 absolute top-1/2 -translate-y-1/2 text-gray-400">
            {rightIcon}
          </div>
        )}
      </div>
