                ...
                {filteredNotifications.map((notification) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <button
                        type="button"
                        className="focus-visible:ring-primary-500 m-2 self-center rounded-2xl p-2 text-gray-400 hover:bg-gray-100 hover:text-red-500 focus-visible:outline-none focus-visible:ring-2"
