    ...
    return (
      <>
        {embedded ? null : (
          <AuthSEO
            title={t(
              maintenanceMode ? 'auth.maintenanceRegisterTitle' : 'auth.registrationClosedTitle'
            )}
            description={t(
              maintenanceMode ? 'auth.maintenanceRegisterLead' : 'auth.registrationClosedLead'
            )}
          />
        )}
        <h1 className="text-2xl font-bold text-gray-900">
          {t(maintenanceMode ? 'auth.maintenanceRegisterTitle' : 'auth.registrationClosedTitle')}
        </h1>
